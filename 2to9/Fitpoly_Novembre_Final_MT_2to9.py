...
params_fit, bounds_fit, params_name_fit, params_target_fit, keyfits_fit = paramfit(params_astro_mw, lowers, uppers, params_name, params_target, keyfits)
#
