...
def mask_src(evt_ras, evt_decs, src_ras, src_decs, src_radius, radius=0.01):
    ...
    for i, (r,d,º) in enumerate(zip(src_ras, src_decs, src_radius)):
...
EXPOSURE_FILE = "/home/jortecal/GitHub/eRosita/Test/Sculptor_Files/expmap_srcreg_comb_Sculptor_rad2deg_rebin40.fits"
#EXPOSURE_FILE = "/Users/marcotaoso/Documents/2024/eROSITA/testSculpt/Data/expmap_comb_Sculpt_rebin40_1-10keV.fits"

SELREG_IMAGE_FILE = "/home/jortecal/GitHub/eRosita/Test/Sculptor_Files/selreg_image_comb_Sculptor_rad2deg.fits"
...
#https://www.griddataaanda.org/articles/aa/pdf/2024/02/aa47165-23.pdf
...
plt.colorbar()
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Countmap.png')
...
plt.colorbar()
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Countmap_unmasked.png')
...
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Counts.pdf')
...
plt.colorbar()
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Ratemap.png')
...
plt.colorbar()
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Ratemap_unmasked.png')
...
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Rate.pdf')

#plt.show()


np.savetxt('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/rate_masked.dat', list(zip(h2_xedges[:-1],h2_xedges[1:],h2,np.sqrt(cnt2)/np.mean(EXPOSURE_new))),fmt='%1.3f')
np.savetxt('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/counts_masked.dat', list(zip(cnt2_xedges[:-1],cnt2_xedges[1:],cnt2 )),fmt='%1.3f')
...
plt.legend(fontsize=15)
plt.tight_layout()
plt.savefig('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/Flux.pdf')

np.savetxt('/home/jortecal/GitHub/eRosita/Test/MTScript_Files/Sculptor/flux_masked.dat', list(zip(hflux_xedges[:-1],hflux_xedges[1:],hflux,np.sqrt(hfluxerr))),fmt='%1.3f')
