...
# SELREG_IMAGE_FILE = "image_comb_LMC_rebin40_1-10keV.fits"
...
if os.path.exists('/home/jortecal/GitHub/eRosita/Test/mask_pointsrc_events_indeces.npy'):
    mask_pointsrc = np.load('/home/jortecal/GitHub/eRosita/Test/mask_pointsrc_events_indeces.npy')
else:
    mask_pointsrc = mask_src(RA, DEC, src_RA[sel_src], src_DEC[sel_src], radius=SRC_MASK_RAD)
    np.save('/home/jortecal/GitHub/eRosita/Test/mask_pointsrc_events_indeces.npy', mask_pointsrc)
