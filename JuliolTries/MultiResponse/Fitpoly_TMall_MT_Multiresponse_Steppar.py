...
#     if Fit.statistic < TS:
#         TS =  Fit.statistic
#         print("New best fit found with PhoIndex:", phoindex)
#         phoindex_m_initial =initial = return_param_value(params_initial, params_name_initial, params_target_initial, "powerlaw", "PhoIndex")
#         nor return_param_value(params_initial, params_name_initial, params_target_initial, "powerlaw", "norm")
...
Fit.steppar("mpb:1 -3 6 10 mpb:2 0 15 15")
...
for i, A in enumerate(profile_range):
    ...
    # Fit.steppar("mpb:1 -3 6 10 mpb:2 0 15 30")
