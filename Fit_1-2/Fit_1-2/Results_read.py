...
def plot_all_TM_profiles(base_folder, Eline):
        ...
        try:
            ...
            with h5py.File(filepath, "r") as f:
                ...
                if TS_astro > TS_vals[0]:
                    ...
                    print("WARNING: T_astro inconsistent")
                ...
                #    print("tm_num ",tm_num," ",TS_min," ",delta_TS)
    ...
    if len(filepaths) >= 2:
        try:
            ...
            print(f"Combined: ΔTS at A=1e-10 = {deltaTS_combined[0]:.2f}")
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        ...
        base_path = "/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_global/Fit_1-2/output/"
