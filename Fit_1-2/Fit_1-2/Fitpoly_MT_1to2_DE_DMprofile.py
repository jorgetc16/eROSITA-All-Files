...
# Script read h5 files containing the fit astro performed by Fitpoly_MT_1to2_DE_Astro.py
# and perform fit with DM (profile likelihood)
#
...
# Load and h5 file with results of fit astro

pathAstroh5 = "/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_global/Fit_1-2/output/"
FileAstroh5_TM1 = pathAstroh5 +"TM1/"
FileAstroh5_TM2 = pathAstroh5 +"TM2/"
FileAstroh5_TM3 = pathAstroh5 +"TM3/"
FileAstroh5_TM4 = pathAstroh5 +"TM4/"
FileAstroh5_TM5 = pathAstroh5 +"TM5/"
FileAstroh5_TM6 = pathAstroh5 +"TM6/"
FileAstroh5_TM7 = pathAstroh5 +"TM7/"
    ...
    for file in files:
        try:
            ...
            with h5py.File(file, "r") as f:
                ...
                params_astro = astro_grp["params_astro"][:]
                params_astro = params_astro.astype(float)
                TS_astro = astro_grp["TS_astro"][()]
                nfit_astro = astro_grp["nfit_astro"][()]
                phoindex_bestfit = astro_grp["PhoIndex"][()]
...
fileIBLineTM1="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM1.txt"
#
...
fileIBLineTM2="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM2.txt"
#
...
fileIBLineTM3="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM3.txt"
#
...
fileIBLineTM4="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM4.txt"
#
...
fileIBLineTM5="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM5.txt"
#
...
fileIBLineTM6="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM6.txt"
#
...
fileIBLineTM7="/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_windows/FixLines2-9/LineResults/IBLine_TM7.txt"
#
...
telescope_files = {
    "TM1": (filespectrumTM1, fileRMFTM1, fileARFTM1, fileIBLineTM1, Energy_width_TM1, FileAstroh5_TM1),
    "TM2": (filespectrumTM2, fileRMFTM2, fileARFTM2, fileIBLineTM2, Energy_width_TM2, FileAstroh5_TM2),
    "TM3": (filespectrumTM3, fileRMFTM3, fileARFTM3, fileIBLineTM3, Energy_width_TM3, FileAstroh5_TM3),
    "TM4": (filespectrumTM4, fileRMFTM4, fileARFTM4, fileIBLineTM4, Energy_width_TM4, FileAstroh5_TM4),
    "TM5": (filespectrumTM5, fileRMFTM5, fileARFTM5, fileIBLineTM5, Energy_width_TM5, FileAstroh5_TM5),
    "TM6": (filespectrumTM6, fileRMFTM6, fileARFTM6, fileIBLineTM6, Energy_width_TM6, FileAstroh5_TM6),
    "TM7": (filespectrumTM7, fileRMFTM7, fileARFTM7, fileIBLineTM7, Energy_width_TM7, FileAstroh5_TM7),
    "ALL": ([filespectrumTM1, filespectrumTM2, filespectrumTM3, filespectrumTM4, filespectrumTM5, filespectrumTM6, filespectrumTM7],
            ...
            [FileAstroh5_TM1, FileAstroh5_TM2, FileAstroh5_TM3, FileAstroh5_TM4, FileAstroh5_TM5, FileAstroh5_TM6, FileAstroh5_TM7]
            ),
    ...
    [FileAstroh5_TM1, FileAstroh5_TM2, FileAstroh5_TM3, FileAstroh5_TM4, FileAstroh5_TM6])
}

# Set the file arrays based on telescope selection
if telescope in telescope_files:
    if telescope == "ALL":
        vfilespectrum, vfileRMF, vfileARF, vfileIBLine, vEnergyWidth, vFileAstroh5 = telescope_files[telescope]
    else:
        spectrum_file, rmf_file, arf_file, ibline_file, energy_width_file, FileAstroh5, = telescope_files[telescope]
        vfilespectrum = [spectrum_file]
        vfileRMF = [rmf_file]
        vfileARF = [arf_file]
        vfileIBLine = [ibline_file]
        vEnergyWidth = [energy_width_file]
        vFileAstroh5 = [FileAstroh5]
...
def doFit(mymodel_mw, mymodel_pb,
    ...
    if TypeFit == "XSpec":
        ...
        #    maxiter=10000,init='sobol',polish=False) #popsize=30 # maxiter=10000
        #
        # From F-D-S
        #out = optimize.differential_evolution(combined.evaluate, combined.bounds, polish = False,
        #    tol = 1e-4, atol = 0, popsize = 300, init = 'sobol', maxiter=500000) #popsize = 120 #maxiter=160000
...
params_astro_mw, params_astro_pb,TS_astro,pvalue_astro,dof_astro,nfit_astro = read_fit_astro(vFileAstroh5[0])

##############################################################################
# I SHOULD PUT DM LINE AT THE RIGHT PLACE WITH RIGHT SIGMA.
# Astro-FIT contains only correct astro parameters!
change_param_value(params_astro_mw, params_name, params_target, "gaussian", "norm", smallnormlower)
change_param_value(params_astro_mw, params_name, params_target, "gaussian", "LineE", Eline)
change_param_value(params_astro_mw, params_name, params_target, "gaussian", "Sigma", sigmaDM)
###############################################################################
...
print("CHECK")
print("TS ",Fit.statistic," TS astro h5 file ",TS_astro)
