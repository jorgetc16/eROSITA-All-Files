...
File_fluxlimit_new = np.loadtxt("/Users/marcotaoso/Documents/2024/eROSITA/xSpec/LMC_5deg/Fit_global/Fit_1-2/output/CombinedProfiles/CombinedBounds.dat",skiprows=1)
vEline_new = File_fluxlimit_new[:,0]
vFluxlim_new = File_fluxlimit_new[:,1]
...
vMdm_kev_new, vSinsq2theta_new = FSinsq2theta(vEline_new,vFluxlim_new,Dfactor_wmask)
...
vMdm_kev_alp_new, vgagg_new = Fgagg(vEline_new,vFluxlim_new,Dfactor_wmask)

# Tau
vMdm_kev_tau, vbound_tau = bound_tau(vEline, vFluxlim, Dfactor_wmask, nphoton=1)

vMdm_kev_tau_new, vbound_tau_new = bound_tau(vEline_new,vFluxlim_new, Dfactor_wmask, nphoton=1)
...
ax1.plot(vMdm_kev_new, vSinsq2theta_new, color='black',linewidth=lweROSITA)
...
ax1.plot(vMdm_kev_alp_new, vgagg_new, color='black',linewidth=lweROSITA)
...
ax1.plot(vEline_new, vFluxlim_new, color='black',linewidth=lweROSITA)
...
ax1.plot(vMdm_kev_tau_new, vbound_tau_new, color='black',linewidth=lweROSITA)
