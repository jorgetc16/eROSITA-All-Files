...
irred_data_path = "/home/jortecal/GitHub/eRosita/PhotoPhillic_TRH=5MeV.csv"
...
Literature_file ='/home/jortecal/GitHub/eRosita/DM/DM/Bound_tau_Literature.txt'
Our_file = '/home/jortecal/GitHub/eRosita/DM/DM/Bound_tau_OURS.txt'
...
for i in range(len(ama_eROSITA_up)):
    print(f"m = {ama_eROSITA_up[i]:.3e} keV, g_low = {ga_bound_eROSITA_low[i]:.3e} GeV^-1, g_up = {ga_bound_eROSITA_up[i]:.3e} GeV^-1")
...
plt.tight_layout()
plt.savefig('Bounds_Irriducible_ALP.pdf')
